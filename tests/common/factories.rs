...
impl RegistrationFactory {
    /// Create a valid registration options request
    pub fn valid_options_request() -> Value {
        json!({
    ...
    /// Create a registration options request with minimal fields
    pub fn minimal_options_request() -> Value {
        json!({
    ...
    /// Create an invalid registration options request (missing username)
    pub fn invalid_options_request_missing_username() -> Value {
        json!({
            "displayName": "Alice Smith",
            "attestation": "direct"
        })
    ...
    /// Create an invalid registration options request (empty username)
    pub fn invalid_options_request_empty_username() -> Value {
        json!({
            "username": "",
            "displayName": "Alice Smith"
        })
...
/// Factory for creating authentication (assertion) request payloads
...
impl AuthenticationFactory {
    ...
    /// Create a minimal assertion options request
    pub fn minimal_options_request() -> Value {
        json!({
            "username": "bob@example.com"
        })
