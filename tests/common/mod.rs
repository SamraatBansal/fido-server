...
pub fn create_test_registration_credential() -> ServerPublicKeyCredential {
    ServerPublicKeyCredential {
        ...
        get_client_extension_results: Some(AuthenticationExtensionsClientOutputs {
...
pub fn create_test_authentication_credential() -> ServerPublicKeyCredential {
    ServerPublicKeyCredential {
        id: "LFdoCFJTyB82ZzSJUHc-c72yraRc_1mPvGX8ToE8su39xX26Jcqd31LUkKOS36FIAWgWl6itMKqmDvruha6ywA".to_string(),
...
/// Create a mock registration challenge response
pub fn create_mock_registration_response(challenge: &ServerPublicKeyCredentialCreationOptionsResponse) -> serde_json::Value {
    json!({
