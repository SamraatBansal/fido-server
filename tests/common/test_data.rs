...
/// Create a valid assertion options request for testing
pub fn create_test_assertion_options_request() -> ServerPublicKeyCredentialGetOptionsRequest {
...
/// Create a test attestation result request
pub fn create_test_attestation_result_request() -> AttestationResultRequest {
...
/// Create a test assertion result request
pub fn create_test_assertion_result_request() -> AssertionResultRequest {
