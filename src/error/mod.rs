...
impl ResponseError for AppError {
    fn error_response(&self) -> HttpResponse {
        match self {
            ...
            AppError::WebAuthn(_) => HttpResponse::BadRequest().json(serde_json::json!({
            ...
            AppError::InvalidChallenge(_)
            | AppError::InvalidSignature
            | AppError::UserVerificationFailed
            | AppError::AttestationVerificationFailed(_) => {
            ...
            AppError::SessionExpired => HttpResponse::Unauthorized().json(serde_json::json!({
